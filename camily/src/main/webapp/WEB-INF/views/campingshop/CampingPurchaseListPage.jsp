						...
						<div class="wrap-table-shopping-cart">
							...
							<table class="table-shopping-cart">
								<tr class="table_head">
									...
									<th class="column-2">${Purchase.godate}</th>
									<th class="column-3">상품가격</th>
									<th class="column-4">상품수량</th>
									<th class="column-5">총금액</th>
									<th class="column-6">주문주소</th>
									<th class="column-7">	</th>
									<th class="column-8">진행상태</th>
								</tr>
								<tr class="table_row" id="${Purchase.gocode}">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="${pageContext.request.contextPath}/resources/campingShopfileUpLoad/${Purchase.goimage }" alt="IMG">
										</div>
									</td>
									...
									<th class="column-7" > 
									 ...
									 onclick="deleteph(this,'${Purchase.gocode}','${Purchase.gostate }')" class="flex-c-m stext-101 cl5 size-80 bg2 bor1 hov-btn1 p-lr-15 trans-04">삭제</button>
									</th>
									<td class="column-8">
								    
								    <c:if test="${Purchase.gostate == 2 }">
									  <p>배송준비중</p>								    
								      <button type="button" class="flex-c-m stext-101 cl5 size-80 bg2 bor1 hov-btn1 p-lr-15 trans-04" onclick="PurchaseDelete('gocode')">주문취소</button>
								    </c:if>
								    
								    <c:if test="${Purchase.gostate == 3 }">
									  <p>배송중</p>				
									  <button type="button" class="flex-c-m stext-101 cl5 size-80 bg2 bor1 hov-btn1 p-lr-15 trans-04">주문취소</button>				    
								    </c:if>
								    
								    <c:if test="${Purchase.gostate == 4 }">
									  <p>배송완료</p>
									 	<button style="margin-top: 100px" type="button" onclick="phDecide('${Purchase.gocode}')"
									    class="flex-c-m stext-101 cl5 size-80 bg2 bor1 hov-btn1 p-lr-15 trans-04">구매확정</button>															  															    
								    </c:if>
								     
								    <c:if test="${Purchase.gostate == 5 }">
									  <p>구매완료</p>								    
									     <a href="cgWrite?image=${pageContext.request.contextPath}/resources/campingShopfileUpLoad/${Purchase.goimage }&gogcode=${Purchase.gogcode}&gocode=${Purchase.gocode }" style="margin-top: 100px"
