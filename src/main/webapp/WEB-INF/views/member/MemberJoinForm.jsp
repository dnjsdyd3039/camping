							...
							<div class="card-body p-md-5">
								<div class="row justify-content-center">
									<div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
										...
										<form class="mx-1 mx-md-4" action="memberJoin" method="post" onsubmit="return memberCheck()">
											...
											<div class="d-flex flex-row align-items-center mb-4">
												<div class="form-outline flex-fill mb-0">
													...
													<input type="text" id="inputMid" class="form-control" name="mid"/>
											...
											<div class="d-flex flex-row align-items-center mb-4">
												<div class="form-outline flex-fill mb-0">
													...
													<div style="color: red; font-size: 13px" class="Np"></div>
													<input type="password" id="inputMpw" class="form-control" name="mpw"/>
												</div>
											</div>
											...
											<div class="d-flex flex-row align-items-center mb-4">
												<div class="form-outline flex-fill mb-0">
													<i class="fas fa-lock fa-lg me-1 fa-fw"></i>
													 <label class="form-label" for="form3Example4c">이름</label> 
													 <div style="color: red; font-size: 13px" class="Np"></div>
													 <input type="text" id="inputMname" class="form-control" name="mname" />
												</div>
											</div>
											...
											<div class="d-flex flex-row align-items-center mb-4">
												<div class="form-outline flex-fill mb-0">
													...
													<label class="form-label" for="form3Example4cd">전화번호</label>
													<div style="color: red; font-size: 13px" class="Np"></div>
													<input type="text" id="inputTel" class="form-control" name="mtel" />
												</div>
											</div>
											...
											<div class="form-outline flex-fill mb-0">
											<i class="fas fa-key fa-lg me-1 fa-fw"></i> 
											<label class="form-label" for="form3Example4cd">이메일</label>
											<div style="color: red; font-size: 13px" class="Np"></div>
											...
											<div class="d-flex flex-row align-items-center mb-4">
												<div class="form-outline flex-fill mb-0">
													<i class="fas fa-key fa-lg me-1 fa-fw"></i>
													 <label class="form-label" for="form3Example4cd">생년월일</label> 
													 <input type="date" id="inputDate" class="form-control" name="mbirth" />
												</div>
											</div>
