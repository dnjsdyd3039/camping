							...
							<div class="card-body p-md-5">
								<div class="row justify-content-center">
									<div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
										...
										<p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">내정보</p>
										...
										<form class="mx-1 mx-md-4">
											...
											<div class="d-flex flex-row align-items-center mb-4">
												<div class="form-outline flex-fill mb-0">
													<i class="fas fa-envelope fa-lg me-1 fa-fw"></i> <label
														...
														type="text" id="form3Example3c" class="form-control" readonly="readonly"/>
													<button type="button" class="btn btn-secondary btn-ml">비밀번호 변경</button>
												</div>
											</div>
											...
											<div class="d-flex flex-row align-items-center mb-4">
												<div class="form-outline flex-fill mb-0">
													<i class="fas fa-lock fa-lg me-1 fa-fw"></i> <label
														class="form-label" for="form3Example4c">이름</label> <input
											...
											<div class="d-flex flex-row align-items-center mb-4">
												<div class="form-outline flex-fill mb-0">
													<i class="fas fa-key fa-lg me-1 fa-fw"></i> <label
														class="form-label" for="form3Example4cd">전화번호</label> <input
											...
											<div class="d-flex flex-row align-items-center mb-4">
												<div class="form-outline flex-fill mb-0">
													<i class="fas fa-key fa-lg me-1 fa-fw"></i> <label
														class="form-label" for="form3Example4cd">이메일</label> <input
														type="password" id="form3Example4cd" class="form-control" />
												</div>
											</div>
											...
											<div class="d-flex flex-row align-items-center mb-4">
												<div class="form-outline flex-fill mb-0">
													<i class="fas fa-key fa-lg me-1 fa-fw"></i> <label
														...
														type="date" id="form3Example4cd" class="form-control" />
												</div>
											</div>
																																																				
											<div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
												<button type="button" class="btn btn-dark btn-ml">회원정보수정</button>
											</div>
