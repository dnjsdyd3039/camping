...
<html class="no-js"  lang="en">
	...
	<head>
		...
		<!-- favicon img -->
		<link rel="shortcut icon" type="image/icon" href="${pageContext.request.contextPath }/resources/assets/logo/favicon.png"/>
	...
	<body>
		...
		<footer  class="footer-copyright">
			<div class="container">
				...
				<div class="foot-icons ">
		        	...
		        	<p>&copy; 2017 <a href="${pageContext.request.contextPath }/resources/https://www.themesine.com">ThemeSINE</a>. All Right Reserved</p>
		...
		<script src="${pageContext.request.contextPath }/resources/assets/js/jquery.filterizr.min.js"></script>
