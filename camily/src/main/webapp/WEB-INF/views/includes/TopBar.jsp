...
<header>
	...
	<div class="container-menu-desktop">
		...
		<!-- 회원가입 모달 -->
		<form action="memberJoin" method="post" id="joinForm" onsubmit="return memberCheck()">
			<div class="modal fade" id="JoinModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<button class="close text-right font-weight-bold mt-2 mr-2" type="button" data-dismiss="modal"
							aria-label="Close">
						...
						<div class="modal-body mx-3">
							<div class="md-form mb-3">
								<input type="text" id="inputMid" class="form-control validate" placeholder="아이디"
									name="mid" onkeyup="this.value=this.value.replace(/[^a-zA-Z0-9]/g,'');">
								<span id="idCheckMsg" style="font-size:13px"></span>
							</div>

							<div class="md-form mb-3">
								<input type="password" id="inputMpw" class="form-control validate" placeholder="비밀번호"
									name="mpw">
							</div>
							<div class="md-form mb-3">
							...
							<div class="md-form mb-3">
								<input type="text" id="inputMname" class="form-control validate" placeholder="이름"
									name="mname" onkeyup="this.value=this.value.replace(/[^ㄱ-ㅎ|가-힣]/g,'');">
							...
							<div class="row">
								<div class="col-sm-8 md-form mb-3">
									<input type="email" id="inputMemail" class="form-control validate" placeholder="이메일"
										name="memail">
									<input type="hidden" id="inputCheckNum" class="form-control validate"
										placeholder="인증번호 입력">
							...
							<div class="md-form mb-3">
								<input type="date" id="inputBirth"
									class="form-control validate date_empty placeholder-date" name="mbirth"
									data-placeholder="생년월일">
							</div>
							<div class="row">
								<div class="col-sm-6 md-form mb-3">
									<input type="text" id="sample6_postcode" class="form-control validate"
										placeholder="우편번호" name="mpostcode">
								</div>
								<div class="col-sm-6 md-form mb-3">
							...
							<div class="md-form mb-3">
								<input type="text" id="sample6_address" class="form-control validate" placeholder="주소"
									name="maddress">
							</div>

							<div class="row">
								<div class="col-sm-6 md-form mb-3">
									<input type="text" id="sample6_detailAddress" class="form-control validate"
										placeholder="상세주소" name="mdetailAddr">
								</div>
								<div class="col-sm-6 md-form mb-3">
									<input type="text" id="sample6_extraAddress" class="form-control validate"
										placeholder="참고항목" name="mextraAddr">
								</div>
							</div>
						</div>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body mx-3">
							...
							<div class="md-form mb-3">
								<input type="text" class="form-control validate loginInput" placeholder="아이디"
									name="mid">
							</div>

							<div class="md-form mb-3">
								<input type="password" class="form-control validate loginInput" placeholder="비밀번호"
									name="mpw" onkeyup="checkCapsLock(event)">
							...
							<div class="md-form mb-1 text-center">
								<a href="#" onclick="findIdForm();">아이디 찾기</a> | <a href="#"
									onclick="findPwForm();">비밀번호 찾기</a> | <a href="#" onclick="memberJoin();">회원가입</a>
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body mx-3">
						...
						<div class="md-form mb-3">
							...
							<input type="button" id="modifyBtn" class="btn btn-dark btn-user btn-block" value="비밀번호 변경"
								onclick="openModifyInput();">
							<input type="hidden" id="modifySubmitBtn" class="btn btn-dark btn-user btn-block"
								value="비밀번호 변경하기" onclick="modifyPw('${sessionScope.loginId}')">
						</div>

						<div class="md-form mb-3">
							<input type="hidden" class="form-control modifyNowPw" id="loginPw" name="mpw"
								type="password" placeholder="현재 비밀번호">
							<input type="hidden" class="form-control modifyPw" id="modifyPwInput" name="mpw"
								type="password" placeholder="새 비밀번호">
							<input type="hidden" class="form-control modifyPw" id="modifyPwInputCheck" name="mpw"
						...
						<div class="md-form mb-3">
							...
							<input type="text" id="infoMtel" class="form-control validate" name="mtel"
								readonly="readonly">
						</div>
						<div class="md-form mb-3">
							<label class="small mb-1">이메일</label>
							<input type="text" id="infoMemail" class="form-control validate" placeholder="이메일"
								name="memail" readonly="readonly">
						</div>
						<div class="md-form mb-3">
							<label class="small mb-1">생년월일</label>
							<input type="text" id="infoMbirth" class="form-control validate" name="mbirth"
								readonly="readonly">
						</div>
						<div class="md-form mb-3">
							<label class="small mb-1">주소</label>
							<input type="text" id="infoMaddr" class="form-control validate" name="maddr"
								readonly="readonly">
						</div>
					</div>
					<div class="modal-footer d-flex justify-content-center">
		...
		<!-- 아이디 찾기 모달 -->
		<div class="modal fade" id="findIdModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
			aria-hidden="true" style="z-index: 5000">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<button class="close text-right font-weight-bold mt-2 mr-2" type="button" data-dismiss="modal"
					...
					<div class="modal-body mx-3">
						<div class="row">
							<div class="col-sm-8 md-form mb-3">
								<input type="text" id="findId_inputName" class="form-control validate findId"
									placeholder="이름 " name="mid">
							</div>
						</div>
						<div class="row">
							<div class="col-sm-8 md-form mb-3">
								<input type="email" id="findId_inputEmail" class="form-control validate findId"
									placeholder="이메일" name="memail">
								<input type="hidden" id="findId_CheckNum" class="form-control validate findId"
									placeholder="인증번호 입력">
						...
						<div class="md-form mb-3">
							<input type="hidden" id="findIdSuccessText" class="form-control validate"
								readonly="readonly">
						</div>
		...
		<!-- 비밀번호 찾기 모달 -->
		<form id="findPwForm2">
			<div class="modal fade" id="findPwModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
				aria-hidden="true" style="z-index: 5000">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<button class="close text-right font-weight-bold mt-2 mr-2" type="button" data-dismiss="modal"
						...
						<div class="modal-body mx-3">
							<div class="row">
								<div class="col-sm-8 md-form mb-3">
									<input type="text" id="findPw_inputId" class="form-control validate findPw"
										placeholder="아이디 입력">
								</div>
								<div class="col-sm-4 md-form mb-3">
									<button class="btn btn-dark btn-block" type="button" id="findPwNext_Btn"
										onclick="findPwNext();">다음</button>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-8 md-form mb-3">
									<input type="hidden" id="findPw_inputEmail" class="form-control validate findPw"
										placeholder="이메일" name="memail" readonly="readonly">
								</div>

								<div class="col-sm-4 md-form mb-3">
									<button class="btn btn-dark" type="button" id="findPw_emailCheck_btn"
										hidden="hidden">인증번호 발송</button>
								</div>
							</div>

							<div class="row">
								<div class="col-sm-8 md-form mb-3">
									<input type="hidden" id="findPw_CheckNum" class="form-control validate findPw"
										placeholder="인증번호 입력">
									<span id="findPw_EmCheckMsg"></span>
								</div>
								<div class="col-sm-4 md-form mb-3">
									<button class="btn btn-dark btn-block" type="button" id="findPwCheckNext"
										hidden="hidden">다음</button>
								</div>
							</div>

							<div class="md-form mb-3">
								<input type="hidden" class="form-control findPw_newPw findPw" id="findPw_newPw"
									placeholder="새 비밀번호">
								<input type="hidden" class="form-control findPw_newPw findPw" id="findPw_newPwCheck"
		...
		<div class="wrap-menu-desktop">
			<nav class="limiter-menu-desktop container">
				...
				<a href="${pageContext.request.contextPath }/" class="logo"> <img
						src="${pageContext.request.contextPath}/resources/images/icons/logo-01.png" alt="IMG-LOGO">
				</a>
				...
				<div class="menu-desktop">
					<ul class="main-menu">
						...
						<li><a href="index.html">캠핑용품</a></li>
			...
			success: function (response) {
				...
				Kakao.API.request({
					...
					success: function (res) {
						...
						console.log("res.kakao_account.profile.nickname : " + res.kakao_account
							.profile.nickname);
						console.log("res.kakao_account.profile.profile_image_url : " + res
							.kakao_account.profile.profile_image_url);

						kakaoLogin(res.id, res.kakao_account.email, res.kakao_account.profile
							.nickname, res.kakao_account.profile.profile_image_url);
						//아이디, 이메일, 닉네임, 프로필
